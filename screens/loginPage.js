...
async _loadAssetsAsync() {
    const imageAssets = cacheImages([
      require('./assets/tumblrmxnb_hzvzoizO.jpg'),
    ]);
        ...
        <View style={{flex:1, backgroundColor:'white', justifyContent:'flex-end'}}>
          <Animated.View style={{...StyleSheet.absoluteFill, transform:[{translateY:this.bgY}]}}>
           ...
           <ClipPath id='clip'>
            ...
            <Image
              href={require('./assets/tumblrmxnb_hzvzoizO.jpg')}
          ...
          <View style={{height:Dimensions.get('window').height/3,justifyContent:'center'}}>
            ...
            <Animated.View style={{...styles.loginButton, backgroundColor:'#2E71DC', opacity:this.buttonOpacity, transform:[{translateY:this.buttonY}]}}>
              <Text style={{...styles.loginButtonText, color:'white' , justifyContent:'center' }}>SIGN IN WITH <FontAwesome5 name='google' size={22} color='#28CF30' style={{justifyContent:'center'}} /></Text>
            </Animated.View>
